...
{
    protected static string $relationship = 'quoteDetails';
...
//                                            ]),
        ...
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->after(function (QuoteItem $record, Component $livewire) {
    ...
    protected function updateTotalSale(QuoteItem $record)
    {
        $idSale = $record->sale_id;
        $sale = QuoteModel::where('id', $idSale)->first();
        ...
        if ($sale) {
            try {
                ...
                $montoTotal = QuoteItem::where('sale_id', $sale->id)->sum('total') ?? 0;
                //            dd($montoTotal);
