                        ...
                        if ($data['confirmacion'] === 'si') {
                            ...
                            if($record->uuid_hacienda == null){
                                Notification::make('error')
                                    ->title('Contingencia!')
                                    ->body('No se puede cerrar la contingencia')
                                    ->danger()
                                    ->send();
...
//                            dd($resultado);
                            if($resultado){
                                Notification::make('success')
                                    ->title('Contingencia!')
                                    ->body('Se ha cerrado la contingencia correctamente')
                                    ->success()
                                    ->send();
                                ...
                                Notification::make('error')
                                    ...
                                    ->body('No se pudo cerrar la contingencia')
                                    ->danger()
                                    ->send();
                            ...
                            Notification::make('error')
                                ->title('Contingencia!')
                                ->body('No se cerró la contingencia')
                                ->danger()
                                ->send();
