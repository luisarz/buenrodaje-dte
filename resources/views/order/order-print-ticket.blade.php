...
<div class="header">
    ...
    <table style="width: 100%; padding: 0; border-collapse: collapse;">
        <tr>
            <td style="width: 100%; text-align: left; vertical-align: middle; padding-right: 10px;">
    ...
    <table width="100%" style="border: 0px solid black; border-collapse: collapse;">
        ...
        @foreach ($datos->saleDetails as $item)
            ...
            <tr>
                <td></td>
                <td colspan="3" style="font-size: 9.5px; line-height: 1.4; padding-left: 5px;">
{{--                    @if(!empty($item->inventory->product->sku))--}}
{{--                        <span style="display: block; font-weight: bold; color: #444;">--}}
{{--            SKU: {{ $item->inventory->product->sku }}--}}
{{--        </span>--}}
{{--                    @endif--}}

                    @if(!empty($item->description))
                        <span style="display: block; margin-top: 2px; font-weight: bold; color: #333;">
            DESCRIPCIÓN:
        </span>
                        <span style="display: block; color: #555; white-space: pre-line;">
            {{ $item->description ?? '' }}
        </span>
                    @endif
                </td>
